...
let map_tok_pat_8cc7dbf (env : env) (tok : CST.tok_pat_8cc7dbf) =
  token env tok (* tok_pat_8cc7dbf *)
...
and map_record_base_ (env : env) (x : CST.record_base_) =
  (match x with
...
and map_record_declaration (env : env) ((v1, v2, v3, v4, v5, v6, v7, v8, v9) : CST.record_declaration) =
  ...
  let v8 =
    List.map (map_type_parameter_constraints_clause env) v8
  in
  let v9 = map_record_base_ env v9 in
  todo env (v1, v2, v3, v4, v5, v6, v7, v8, v9)
